...
- **Smart-ID app interaction**: User sees the exact transaction details (amount, beneficiary) on the Smart-ID app screen (which appeared from the Vault's push). This is the certified eIDAS display.
