# e2e-extension-tests Specification

## Purpose

Define the Playwright E2E test patterns for verifying extension behavior in a real Chromium browser. Tests load the built extension, create extension-aware browser contexts, and verify that content scripts inject correctly, popup panels render, and messaging flows work end-to-end. Tests MUST NOT silently skip extension-specific assertions.
## Requirements
