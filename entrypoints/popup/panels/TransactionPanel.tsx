...
export const TransactionPanel = forwardRef<HTMLHeadingElement>(
  function TransactionPanel(_props, headingRef) {
    ...
    if (transactionState === 'confirmed') {
      return (
        <div className="p-4 bg-green-50 rounded-lg border border-green-200 text-center">
          ...
          <p className="text-green-700 text-sm" aria-live="assertive">
            Transaction verified on your phone
          </p>
          <button
            type="button"
      ...
      return (
        <div className="p-4 bg-red-50 rounded-lg border border-red-200 text-center">
          ...
          <p className="text-red-600 text-sm" aria-live="assertive">
            {error ?? 'Transaction was rejected on your phone'}
          </p>
          <button
            type="button"
        ...
        {transactionState === 'verifying' && (
          <div className="text-center py-3" aria-live="assertive">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Challenge-Bound WebAuthn assertion in progress
            </p>
          </div>
        )}
      </div>
